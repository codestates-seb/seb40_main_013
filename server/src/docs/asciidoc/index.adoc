...
=== 상품 대분류 조회
.http-request
include::{snippets}/products/main/get/http-request.adoc[]

.path-parameters
[caption=]
include::{snippets}/products/main/get/path-parameters.adoc[]

.http-response
include::{snippets}/products/main/get/http-response.adoc[]

.response-fields
[caption=]
include::{snippets}/products/main/get/response-fields.adoc[]
