...
=== 회원 리뷰 조회
.curl-request
include::{snippets}/members/reviews/curl-request.adoc[]
...
=== 리뷰 등록
.curl-request
include::{snippets}/reviews/post/curl-request.adoc[]
...
=== 리뷰 수정
.curl-request
include::{snippets}/reviews/patch/curl-request.adoc[]
...
=== 리뷰 삭제
.curl-request
include::{snippets}/reviews/delete/curl-request.adoc[]
