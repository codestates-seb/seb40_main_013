...
export const getArticleDetail = createAsyncThunk("products/detail", async (id) => {
...
export const postCart = createAsyncThunk("carts", async ({ postData, navigate, clickCheckFunction }) => {
...
export const deleteShoppingCart = createAsyncThunk("getShoppingCart", async (elId) => {
...
export const postPayment = createAsyncThunk("getShoppingCart", async ({ checkList, navigate }) => {
  return Apis.post(
    `orders`,
    {
...
export const reCountCartItem = createAsyncThunk("getShoppingCart", async ({ productCartId, itemCount }) => {
  return Apis.patch(
    `carts/${productCartId}`,
    {
...
export const getSearchResult = createAsyncThunk("getSearchResult", async ({ storageWord, page, sortArgument, third }) => {
  return Apis.get(`/products/search?title=${storageWord}&page=${page}&sortType=${sortArgument}&order=${third}`)
    .then((res) => {
      return res.data;
    })
    .catch((err) => {
...
export const countSearchResult = createAsyncThunk("countSearchResult", async (searchWord) => {
...
export const getSubCount = createAsyncThunk("getCount", async ({ mainCateClick, subclick }) => {
...
export const postArticle = createAsyncThunk("postArticle", async ({ postArticleData, navigate }) => {
